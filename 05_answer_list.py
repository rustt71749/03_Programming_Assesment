...
equation2 = int_check(question, -(highest*highest), highest*highest)
...
equation3 = int_check(question, -(highest*highest), highest*highest)
...
equation4 = int_check(question, -(highest*highest), highest*highest)
